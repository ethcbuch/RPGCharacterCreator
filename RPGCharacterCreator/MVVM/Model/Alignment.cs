...
namespace RPGCharacterCreator.MVVM.Model
{
    ...
    [XmlInclude(typeof(LawfulEvil))]
    [XmlInclude(typeof(NeutralEvil))]
    [XmlInclude(typeof(ChaoticGood))]
    [XmlInclude(typeof(LawfulGood))]
    [XmlInclude(typeof(NeutralGood))]
    [XmlInclude(typeof(ChaoticNeutral))]
    [XmlInclude(typeof(TrueNeutral))]
    [XmlInclude(typeof(LawfulNeutral))]
    ...
    public class TrueNeutral : Alignment
    {
